...
var _InputFactory = __webpack_require__(10);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

this.inputs = [];
var descriptions = opts.input_descriptions;
var factory = new _InputFactory.InputFactory();
...
var _TextAreaField = __webpack_require__(12);

var _PasswordField = __webpack_require__(13);

var _SelectField = __webpack_require__(14);

var _CheckField = __webpack_require__(15);
  ...
  */
  function build(inputDescription) {
    ...
    switch (inputDescription.type.toLowerCase()) {
      case "text":
        return new _TextField.TextField(inputDescription);
        break;
      case "textarea":
        return new _TextAreaField.TextAreaField(inputDescription);
        break;
      case "password":
        return new _PasswordField.PasswordField(inputDescription);
        break;
      case "checkbox":
        return new _CheckField.CheckField(inputDescription);
        break;
      case "select":
        return new _SelectField.SelectField(inputDescription);
        break;
      default:
...
var _AbstractField = __webpack_require__(1);

/**
  Create a text input.
*/
var TextField = function TextField(inputDescription) {
  (0, _extend.extend)(this, _AbstractField.AbstractField);
